...
La aplicación está hecha con Servlet/JSP puro y acceso a datos manual con JDBC (sin frameworks MVC ni ORM), siguiendo la guía "CRUD JSP + JDBC" proporcionada por el profe.
